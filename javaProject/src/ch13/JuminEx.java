...
public class JuminEx {
	...
	public static void main(String[] args) {
		...
		char s = jumin.charAt(7); //성별 처리(1,3):남자 , (2, 4): 여자
		if(s == '1' || s == '3') gender = "남";
		else if (s == '2' || s == '4') gender = "여";
		else gender = "외국인";
		
		//나이구하기
		if(s == '1' || s == '2') age = (cal.get(Calendar.YEAR) - (1900+age) + 1);
		else if(s == '3' || s == '4') age = (cal.get(Calendar.YEAR) - (00+age) + 1);
